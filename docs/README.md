...
### 👉[Official Documentation](https://documentation.concretecms.org/developers/appendix/coding-style-guidelines)

Follow the Concrete CMS [official documentation](https://documentation.concretecms.org/developers/appendix/coding-style-guidelines).
...
Check their [official documentation](https://cs.symfony.com/) to integrate with your IDE. Also, Concrete CMS has a command (from 8.5.3) to use it. Please run `./concrete/bin/concrete5 c5:phpcs --help` for detail.
...
- Add a [confirmation dialog](https://documentation.concretecms.org/tutorials/how-to-create-alert-notifications-and-modals) to non-returnable actions.
...
- Don't use [deprecated codes](https://documentation.concretecms.org/developers/appendix/deprecated-code-reference-ongoing).
- Follow the [style guide](https://documentation.concretecms.org/developers/appendix/style-guide).
...
- Contents (Block Types, Single Pages, Express Objects etc.) can be installed [Programmatically](https://documentation.concretecms.org/developers/packages/programmatically-creating-composer-forms-and-controls) or using [CIF](https://documentation.concretecms.org/developers/packages/concrete5-cif-format-1) files. `CIF` is the recommended way to use.
...
- Follow the [official guide](https://documentation.concretecms.org/developers/framework/routing/including-routes-in-packages) to register routes.

### 👉[Single Pages](https://documentation.concretecms.org/developers/pages-themes/working-with-pages/single-pages/overview)

- Follow the [official guide](https://documentation.concretecms.org/developers/pages-themes/working-with-pages/single-pages/sending-data-to-a-page-view) to send data to and from a controller into the page view. Please avoid using ajax unnecessarily.
...
- Use [Object Caching](https://documentation.concretecms.org/developers/framework/caching/overview) to improve performance.
